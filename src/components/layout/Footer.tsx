            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/60 text-sm font-bold">
                  R. Adelaíde Zangrande, 85 - Industrial<br />
                  Jardinópolis - SP, 14680-000<br />
                  <br />
                  Estr. Hondo Japão, 235 - Jamic<br />
                  Jacareí - SP, 12331-680
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-novaag-red shrink-0" />
                <span className="text-white/60 text-sm font-bold">+55 11 9.3499-3434</span>
              </li>
              <li className="flex items-center gap-3">
