      ...
      <div className="flex flex-col gap-8">
        {horizontalProducts.map(product => (
          <React.Fragment key={product.slug}>
            <div className={`rounded-sm overflow-hidden shadow-xl border-t border-white/10 relative ${getBgColor(product.slug)}`}>
            ...
            {product.slug === "phn" && (
              <div className="w-full relative py-16 overflow-hidden rounded-sm">
                <div
                  ...
                  style={{
                    backgroundImage: 'url("/images/background-nutriprotection.jpg")',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                  }}
                />
                <div className="absolute inset-0 bg-[#1A251E]/85 z-0 rounded-sm" />
                ...
                <div className="relative z-10 px-8 md:px-12">
                  ...
                  <div className="flex flex-col gap-10">
                    ...
                    <div>
                      ...
                      <div className="rounded-2xl overflow-hidden shadow-2xl">
                        <img src="/images/PNH/b57bff96-f41d-410d-af5a-3560e180fcf8.png" alt="Dinâmica dos nutrientes" className="w-full h-auto object-contain bg-white" />
                      </div>
                    </div>
                  </div>
                </div>
